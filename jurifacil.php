<?php
$title = "Jurifácil — sistema de gestão jurídica";
$description = "Conheça o Jurifácil, o novo sistema de gestão jurídica que está chegando para ajudar advogados a organizar tarefas, documentos e minutas com simplicidade e segurança.";
$active = "jurifacil";
...
<section class="hero section--tight">
  <div class="container" data-reveal>
    <span class="eyebrow">Novidade</span>
    <h1>Jurifácil</h1>
    <p class="lede">Um sistema de gestão jurídica pensado para o dia a dia real de advogados e escritórios — simples, leve e seguro, sem a complexidade dos grandes sistemas do mercado.</p>
  </div>
</section>
  ...
  <div class="container">
    <div class="about">
      <div data-reveal>
        ...
        <p>O Jurifácil nasce da experiência prática de quem vive essa rotina e está sendo desenvolvido por uma equipe de tecnologia dedicada, com o objetivo de entregar um sistema robusto, simples e seguro para o dia a dia do advogado.</p>
      </div>
      <div class="credentials" data-reveal>
        ...
        <div><strong>Documentos</strong><br>Upload e organização de documentos por caso ou cliente, com segurança.</div>
...
<section class="section section--alt">
  <div class="container">
    <div data-reveal>
      ...
      <p class="lede">O Jurifácil está em construção. As primeiras funcionalidades — gestão de tarefas e documentos — estão em desenvolvimento ativo. A geração de minutas assistida por IA é a próxima etapa do roadmap.</p>
    </div>

    <div class="grid grid--3" style="margin-top:32px;">
      <div class="card" data-reveal>
        <div class="card__icon">1</div>
        <h3>Tarefas e documentos</h3>
...
<section class="section">
  <div class="container text-center" data-reveal>
    ...
    <p class="lede" style="margin:0 auto 24px;">Se você é advogado ou tem um escritório e quer participar do grupo inicial de testes do Jurifácil, entre em contato.</p>
